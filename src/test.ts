...
function verifyAllPropsValidTorrentInfo(torrentInfo: TorrentInfo) {
    ...
    assert(torrentInfo.files !== null && torrentInfo.name !== undefined); 
    assert(torrentInfo.pieceLength !== null && torrentInfo.name !== undefined); 
    assert(torrentInfo.pieces!== null && torrentInfo.name !== undefined); 
    assert(torrentInfo.private !== null && torrentInfo.name !== undefined); 
}
